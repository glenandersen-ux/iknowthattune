...
/** Google "G" logo mark in its brand colours. */
...
/**
 * Navigates to the Google OAuth start endpoint.
 * The whole auth flow happens server-side; the browser just follows the redirect.
 */
